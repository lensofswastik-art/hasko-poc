...
function Stat({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <span ref={ref} className="figure text-[28px] font-semibold text-white sm:text-[32px]">
        {prefix}
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 py-20 sm:px-10 md:py-28">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="flex flex-col border-2 border-ink bg-brand-red">
            <div className="flex flex-wrap items-center justify-between gap-x-8 gap-y-4 bg-black px-6 py-8 sm:px-9">
            ...
            <div className="flex flex-1 flex-col gap-8 p-6 sm:p-9">
              <p className="text-lg leading-none sm:text-2xl sm:leading-relaxed text-white">
                ...
                of square boards are a non-issue.&rdquo;
              </p>

              <div className="flex flex-1 flex-col justify-end gap-6">
                <div className="flex items-center gap-4">
                  <div className="relative size-[72px] shrink-0 overflow-hidden border-2 border-ink sm:size-[100px]">
                    <Image
                  ...
                  <div className="flex flex-col gap-1 text-white">
                    <p className="font-display text-2xl font-semibold uppercase leading-[0.9] sm:text-[32px]">
                      Roger Isaacs
                    </p>
                    <p className="text-base sm:text-xl">Production Manager, SFL</p>
                  </div>
                </div>

                <a
                  href="#machine-finder"
                  className="flex h-12 items-center justify-center gap-1.5 bg-chip px-4 text-base font-semibold text-black transition-colors hover:bg-white"
                >
                  MPEM-C End Matcher
